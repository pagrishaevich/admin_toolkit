...
- SSH-доступ к тестовому серверу `10.82.100.36` без интерактивного пароля в текущей среде не прошел, поэтому серверный тест миграционных скриптов пока не выполнен.
